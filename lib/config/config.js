 ...
 */
const detectDirectoryType = require( '@wordpress/env/lib/config/detect-directory-type' );
const { validateConfig, ValidationError } = require( '@wordpress/env/lib/config/validate-config' );
const readRawConfigFile = require( '@wordpress/env/lib/config/read-raw-config-file' );
...
module.exports = async function readConfig( configPath ) {
	...
	const defaultConfiguration = {
        ...
        // These commands will execute in cli container.
        afterSetup: []
	};
